...
지난 번에 CodeceptJS를 써보면서 CodeceptUI란 도구도 살짝 확인하셨나요? 이런
재밌는 Test Runner 붐을 일으킨 장본인 중 하나가 바로 Cypress입니다. “A test
runner built for humans”란 모토를 내걸고 있죠.
...
Cypress 설치는 매우 평범하고 간단합니다. (하지만 설치 자체는 생각보단 오래
걸립니다. 😆)
...
테스트 코드를 작성/수정만 해도 Cypress 테스터 러너가 자동으로 테스트를 실행하는
걸 볼 수 있습니다.
