...
따르면 사용자가 자신의 콘텐츠에 대한 지적재산권을
보유한다.

다만 몇 가지 제한이 있다.

- **개인적·비상업적 용도**로 허용된다. 스트리밍
  서비스 배포 등 상업적 사용은 별도 라이선스 필요.
- **동일 결과물 가능**: Google이 다른 사용자에게
  동일하거나 유사한 콘텐츠를 생성할 수 있으며
  그 권리를 보유한다고 약관에 명시되어 있다.
- **무료 vs 유료**: 무료 서비스 이용 시 입력과
  생성 결과를 Google 제품 개선에 활용할 수 있다.
  유료 구독(AI Plus/Pro/Ultra)에서는 사용하지 않는다.

AI 생성 콘텐츠의 저작권은 법적으로 미확정 영역이다.
미국 저작권청은 순수 AI 생성물에 대해 저작권 등록을
거부한 전례가 있어, 약관상 "사용자가 보유한다"는
표현과 실제 법적 보호 사이에 간극이 존재한다.

### YouTube 수익화

Gemini 앱에서 생성한 음악을 YouTube 영상의 BGM으로
사용하고 수익화하는 것은 "상업적 사용"에 해당할
가능성이 높아 현재 약관상 명확하지 않다.

YouTube Dream Track은 별도 경로다. Lyria 3 기반이나
레이블(UMG 등)과의 라이선스 하에 작동하며,
Shorts 크리에이터에게 직접 제공된다. 수익 배분의
세부 조건은 공개되지 않았다.

YouTube 자체의 AI 음악 정책도 고려해야 한다.

- AI 음악 수익화 자체는 금지하지 않는다.
- 대량 생산·반복 콘텐츠는 2025년 7월부터
  수익화 제외 대상이다.
