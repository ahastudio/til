...
Shared Example이 범용으로 쓰이면서도 `elements`에 대응하는 걸 알 수 있습니다.  Controller 테스트에서 Shared Example이 좋다는 이야기는 많이 들어보셨겠지만, 몇 가지 사소한 변경점 때문에 적극 활용하는 걸 주저하셨다면, `let`을 이용해 극단적인 재활용의 길을 열어보세요!
