...
Astro는 콘텐츠 중심의 정적 사이트 생성 프레임워크입니다. Markdown으로 글을
작성할 수 있고, 빠르게 검색 엔진에 최적화된 블로그를 만들 수 있습니다.
...
블로그 템플릿으로 생성했기 때문에 이미 몇 개의 샘플 글이 포함되어 있습니다.
...
Astro는 정적 사이트 생성기로, 빠르고 SEO에 최적화된 블로그를 쉽게 만들 수
있습니다.

더 많은 정보를 원하시면 [Astro 공식 문서](https://docs.astro.build/)를
참고하세요.
```

<http://localhost:4321/blog/first-post/>에 접속해서 블로그 첫 글이 잘 보이는지
확인합니다.
...
GitHub Pages 등 무료로 정적 사이트를 호스팅할 수 있는 서비스가 많습니다. Astro
등을 사용하면 이런 무료 호스팅 서비스에 배포할 수 있는 블로그를 쉽고 빠르게 만들
수 있습니다.

GitHub의 Pull Request 기능과 GitHub Actions를 활용하면 팀 블로그를 위한 협업
환경과 자동 배포 환경도 쉽게 구축할 수 있습니다.
