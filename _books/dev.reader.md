...
1. 3월 - 쏙쏙 들어오는 함수형 코딩
1. 4월 - 이펙티브 소프트웨어 테스팅
1. 5월 - Docs for Developers 기술 문서 작성 완벽 가이드
1. 6월 - 필독! 개발자 온보딩 가이드
1. 7월 - 디자인 패턴의 아름다움
1. 8월 - 내 코드가 그렇게 이상한가요?
1. 9월 - 육각형 개발자
1. 10월 - 크리에이티브 프로그래머
1. 11월 - 요즘 우아한 개발
1. 12월 - 타입으로 견고하게 다형성으로 유연하게

## 2024년

1. 1월 - 이벤트 기반 마이크로서비스 구축
1. 2월 - CODE 2판: 하드웨어와 소프트웨어에 숨어 있는 언어
1. 3월 - 가상 면접 사례로 배우는 대규모 시스템 설계 기초 2
1. 4월 - OpenAPI와 스웨거를 활용한 실전 API 설계
1. 5월 - 켄트 벡의 Tidy First?
1. 6월 - 컴퓨터 밑바닥의 비밀
1. 7월 - 관찰 가능성 엔지니어링
1. 8월 - AI 코딩 어시스턴트 깃허브 코파일럿 제대로 활용하기
1. 9월 - 도메인 스토리텔링
1. 10월 - 소프트웨어 개발의 진주
1. 11월 - 소프트웨어 엔지니어 가이드북
1. 12월 - 예제로 배우는 소프트웨어 디자인
...
1. 7월 - 멀티패러다임 프로그래밍
1. 8월 - 코드 밖 커뮤니케이션
1. 9월 - 시스템 설계 면접 완벽 가이드
1. 10월 - 알고리즘 산책: 수학에서 제네릭 프로그래밍까지
1. 11월 - 객체지향 시스템 디자인 원칙
