...
### 1-1. 세션은 기억하지 않는다, 파일은 기억한다

에이전트는 세션이 바뀌면 맥락을 잃는다.
따라서 지식은 대화가 아니라 파일에 축적해야 한다.

- 규칙: `CLAUDE.md`([`AGENTS.md`](https://agents.md/))
- 목표/범위: `TASK.md`
- 장기 맥락: `MEMORY.md`
- 반복 절차: `SKILL.md`
...
### 4-1. 프롬프트 엔지니어링보다 운영 엔지니어링

초기에는 좋은 문장을 찾으려 하지만,
**장기적**으로는 체크리스트, 템플릿, 메모리 파일 같은
**운영 장치**가 성과를 만든다.

### 4-2. AI 도입의 병목은 기술이 아니라 합의
...
### 4-3. 개인 최적화는 빠르고, 팀 최적화는 오래 간다

개인 프롬프트는 빠른 승리를 만든다.
하지만 인수인계, 온보딩, 협업을 고려하면
**문서화된 팀 규칙**이 총비용을 낮춘다.

### 4-4. 생산성의 핵심은 "정답 생성"이 아니라 "재작업 감소"
