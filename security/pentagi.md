...
- 사이트: <https://pentagi.com/>
- 저장소: <https://github.com/vxcontrol/pentagi>

## 한 줄 요약

PentAGI는 LLM 기반 에이전트가 침투 테스트 절차를 단계적으로
수행하도록 설계된 자율형 보안 테스트 플랫폼으로 알려져 있다.

## 왜 주목해야 하나

- GitHub Trending 기준으로 단기간에 큰 star 유입이 발생했다.
...
아래는 자율형 레드팀 도구를 분석할 때 유효한 공통 프레임이다.
PentAGI 코드 리뷰 시에도 우선 이 축으로 보면 빠르게 맥락을
잡을 수 있다.
...
- 프로젝트 홈: <https://pentagi.com/>
- GitHub 저장소: <https://github.com/vxcontrol/pentagi>
- 관련 트렌드 메모: `sandbox.md`의 PentAGI 섹션
