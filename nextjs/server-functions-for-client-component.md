...
- **Server Action**: `<form action={...}>`처럼 폼 제출에 연결된 함수
- **Server Function**: `'use server'`가 붙은 모든 비동기 함수.
  Server Action도 Server Function의 일종이다.

Next.js 공식 문서는 둘을 합쳐 “Server Functions”로 부른다.
